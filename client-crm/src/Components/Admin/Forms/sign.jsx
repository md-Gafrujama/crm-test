        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-6">
            <Suspense fallback={
              ...
              <form
                onSubmit={handleSubmit}
                className="bg-white dark:bg-slate-800 rounded-2xl w-full transition-all"
              >
                <div className="text-center mb-8">
                  <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-400 mb-2">Create Account</h2>
                  <p className="text-gray-500 dark:text-gray-400">Add Users</p>
                ...
                <div className="mb-6 flex flex-col items-center">
                  ...
                  <label className="cursor-pointer">
                    <span className="px-4 py-2 bg-[#ff8633] text-white rounded-lg hover:bg-[#e6732b] transition-colors">
                      Upload Photo
                    </span>
                    <input
                      type="file"
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-4'>
                  ...
                  <div className="relative mb-4">
                    ...
                    <Suspense fallback={<div className="absolute right-3 top-1/2 transform -translate-y-1/2 w-5 h-5 bg-gray-300 rounded-full"></div>}>
                      <button
                        type="button"
                        className="absolute right-3 top-3/4 transform -translate-y-1/2 text-gray-500 dark:text-gray-400 hover:text-gray-700 transition-colors"
                        onClick={() => setShowPassword(!showPassword)}
                        aria-label={showPassword ? "Hide password" : "Show password"}
                      >
                        {showPassword ? <EyeOff className="h-5 w-5" /> : <Eye className="h-5 w-5" />}
